...
import (
	...
	"github.com/asynccnu/be-counter/pkg/errorx"
...
func InitGRPCxKratosServer(CounterServer *grpc.CounterServiceServer, ecli *clientv3.Client, l logger.Logger) grpcx.Server {
	type Config struct {
